...
export default function handdler(req, res) {
	...
	if(method=== 'POST' && body) {
		console.log(body.Question2,body.answer2,body.answer1,body.rightanswer_2,body.uniqueId);
		insertData_2(body.Question2,body.answer2,body.answer1,body.rightanswer_2,body.uniqueId)
...
function insertData_2(Question, answer2, answer1, rightanswer, uniqueId) {
	...
	db.connect((err) => {
	  ...
	  const sql = 'INSERT INTO `div-game` (`uniqueId`, `question`, `answer1`, `answer2`, `rightanswer`, `format`) VALUES (?, ?, ?, ?, ?, ?)';
